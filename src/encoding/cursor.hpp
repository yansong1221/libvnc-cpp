...
class cursor : public codec {
   public:
      ...
      boost::asio::awaitable<error> decode(vnc_stream_type& socket,
         ...
         op->got_cursor_shape(xhot, yhot, rcSource_, rcMask_);
         co_return error{};
      }
...
class x_cursor : public cursor {
   public:
      ...
      boost::asio::awaitable<error> read_rc_source(
         ...
         colors[0] =
            rgb24_to_pixel(rcSource_.pixel_format(), rgb.backRed.value(), rgb.backGreen.value(), rgb.backBlue.value());
         colors[1] =
            rgb24_to_pixel(rcSource_.pixel_format(), rgb.foreRed.value(), rgb.foreGreen.value(), rgb.foreBlue.value());
