...
custom_error::custom_error(code c, std::string msg) : code_(c), message_(std::move(msg)) {}
...
error::error(const boost::system::error_code &system_err) : error_(system_err) {}

error::error(const custom_error &custom_err) : error_(custom_err) {}
